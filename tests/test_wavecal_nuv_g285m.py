"""Tests for COS/NUV G285M wavecal."""
...
@pytest.mark.slow
class TestWavecalNUVG285M(BaseCOS):
    detector = 'nuv'

    def test_wavecal_nuv_g285m(self):
        """
        COS regression test
        """
        files_to_download = ['la7v01dqq_rawtag.fits',
                             'la7v01dqq_spt.fits']

        # Prepare input files.
        self.get_input_files(files_to_download)

        input_file = 'la7v01dqq_rawtag.fits'
        # Run CALCOS
