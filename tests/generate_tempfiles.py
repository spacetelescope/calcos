...
def generate_fits_file(file):
    ...
    hdu.header.set('NAXIS2', 0)
    hdu.header.set('DISPAXIS', 0)
    hdu.header.set('SDQFLAGS', 184)
    hdu.header.set('NSUBARRY', 0)
    hdu.header.set('NUMFLASH', 0)
    hdu.header.set('EXPSTART', -1.0)
    hdu.header.set('EXPEND', -1.0)
    hdu.header.set('DOPPON', False)
    hdu.header.set('DOPPONT', False)
    hdu.header.set('DOPPMAGV', -1.0)
    hdu.header.set('DOPMAGT', -1.0)
    hdu.header.set('DOPPZERO', -1.0)
    hdu.header.set('DOPZEROT', -1.0)
    hdu.header.set('ORBITPER', -1.0)
    hdu.header.set('ORBITPERT', -1.0)
    hdu.header.set('RA_APER', 0.0)
    hdu.header.set('DEC_APER', 0.0)
    hdu.header.set('PA_APER', 0.0)
    
    prim_hdu = fits.PrimaryHDU()
    prim_hdu.header.set('STATFLAG', True, 'Calculate statistics')
    prim_hdu.header.set('DQICORR','COMPLETE')
    prim_hdu.header.set('RANDCORR','COMPLETE')
    prim_hdu.header.set('TEMPCORR','COMPLETE')
    prim_hdu.header.set('GEOCORR','COMPLETE')
    prim_hdu.header.set('IGEOCORR','COMPLETE')
    prim_hdu.header.set('DGEOCORR','OMIT')
    prim_hdu.header.set('XWLKCORR','COMPLETE')
    prim_hdu.header.set('YWLKCORR','COMPLETE')
    prim_hdu.header.set('TRCECORR','OMIT')
    prim_hdu.header.set('ALGNCORR','OMIT')
    prim_hdu.header.set('DEADCORR','COMPLETE')
    prim_hdu.header.set('FLATCORR','COMPLETE')
    prim_hdu.header.set('DOPPCORR','COMPLETE')
    prim_hdu.header.set('HELCORR','PERFORM')
    prim_hdu.header.set('PHACORR','COMPLETE')
    prim_hdu.header.set('BRSTCORR','OMIT')
    prim_hdu.header.set('BADTCORR','OMIT')
    prim_hdu.header.set('X1DCORR','PERFORM')
    prim_hdu.header.set('WAVECORR','COMPLETE')
    prim_hdu.header.set('BACKCORR','PERFORM')
    prim_hdu.header.set('FLUXCORR','PERFORM')
    prim_hdu.header.set('PHOTCORR','None')
    prim_hdu.header.set('TDSCORR','PERFORM')

    prim_hdu.header.set('DETECTOR', 'FUV', 'FUV OR NUV')
    prim_hdu.header.set('SEGMENT', 'FUVA')
    prim_hdu.header.set('OBSTYPE', 'SPECTROSCOPIC', 'operating mode')
    prim_hdu.header.set('OBSMODE', 'TIME-TAG')
    prim_hdu.header.set('EXPTYPE', 'EXTERNAL/SCI')
    prim_hdu.header.set('OPT_ELEM', 'G130M')
    prim_hdu.header.set('TARGNAME', 'MRK-1044')
    prim_hdu.header.set('LAMPUSED', 'P1')
    prim_hdu.header.set('LAMPPLAN', 'P1')
    prim_hdu.header.set('ROOTNAME', 'lbgu17qnq')
    prim_hdu.header.set('SUBARRY', False)
    prim_hdu.header.set('TAGFLASH', 'AUTO')
    prim_hdu.header.set('CENWAVE','1291')
    prim_hdu.header.set('RANDSEED',1602803142)
    prim_hdu.header.set('FPPOS',3)
    prim_hdu.header.set('FPOFFSET',0)
    prim_hdu.header.set('LIFE_ADJ',1)
    prim_hdu.header.set('APERYPOS',126.1)
    prim_hdu.header.set('COSCOORD','USER')
    prim_hdu.header.set('RA_TARG',37.52302083333)
    prim_hdu.header.set('DEC_TARG',-8.998136111111)
    prim_hdu.header.set('XTRCTALG','BOXCAR')

    prim_hdu.header.set('FLATFILE','lref$xab1551cl_flat.fits')
    prim_hdu.header.set('HVTAB','N/A')
    prim_hdu.header.set('XWLKFILE','lref$14o2013ql_xwalk.fits')
    prim_hdu.header.set('YWLKFILE','lref$14o2013rl_ywalk.fits')
    prim_hdu.header.set('BPIXTAB','lref$36d1836ml_bpix.fits')
    prim_hdu.header.set('GSAGTAB','lref$41g2040ol_gsag.fits')
    prim_hdu.header.set('SPOTTAB','lref$zas1615jl_spot.fits')
    prim_hdu.header.set('BRFTAB','lref$x1u1459il_brf.fits')
    prim_hdu.header.set('GEOFILE','lref$x1u1459gl_geo.fits')
    prim_hdu.header.set('DGEOFILE','N/A')
    prim_hdu.header.set('TWOZXTAB','N/A')
    prim_hdu.header.set('DEADTAB','lref$s7g1700gl_dead.fits')
    prim_hdu.header.set('PHAFILE','N/A')
    prim_hdu.header.set('PHATAB','lref$wc318317l_pha.fits')
    prim_hdu.header.set('BRSTTAB','N/A')
    prim_hdu.header.set('BADTTAB','N/A')
    prim_hdu.header.set('TRACETAB','N/A')
    prim_hdu.header.set('XTRACETAB','lref$x1v17414l_1dx.fits')
    prim_hdu.header.set('LAMPTAB','lref$23n1744jl_lamp.fits')
    prim_hdu.header.set('DISPTAB','lref$05i1639ml_disp.fits')
    prim_hdu.header.set('FLUXTAB','lref$23n1744pl_phot.fits')
    prim_hdu.header.set('IMPHTTAB','N/A')
    prim_hdu.header.set('PHOTTAB','None')
    prim_hdu.header.set('SPWCSTAB','lref$49g17154l_spwcs.fits')
    prim_hdu.header.set('WCPTAB','lref$u1t1616ql_wcp.fits')
    prim_hdu.header.set('TDSTAB','lref$46t1623fl_tds.fits')
    prim_hdu.header.set('PROFTAB','N/A')
